...
*/
void
strReplace (char *string, char *substr, char with)
{
  char *pointer;
...
*/
void
delChar (char *string, int pos, int n)
{
  if (strlen (string) < n + pos)
